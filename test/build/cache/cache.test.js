...
describe('cache', () => {
    it('should work', async () => {
        ...
        let { exitCode, stderr, stdout } = await runAsync(__dirname, ['-c', './webpack.config.js']);
        ...
        ({ exitCode, stderr, stdout } = await runAsync(__dirname, ['-c', './webpack.config.js']));
    ...
    it('should work in multi compiler mode', async () => {
        ...
        let { exitCode, stderr, stdout } = await runAsync(__dirname, ['-c', './multi.config.js']);
        ...
        ({ exitCode, stderr, stdout } = await runAsync(__dirname, ['-c', './multi.config.js']));
    ...
    it('should work with autoloading configuration', async () => {
        ...
        let { exitCode, stderr, stdout } = await runAsync(__dirname, ['--name', 'cache-test-autoloading']);
        ...
        ({ exitCode, stderr, stdout } = await runAsync(__dirname, ['--name', 'cache-test-autoloading']));
