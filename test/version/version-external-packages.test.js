...
describe('version flag with external packages', () => {
    it('outputs version with init', () => {
        const { stdout, exitCode } = run(__dirname, ['init', '--version'], false);
    ...
    it('outputs version with the alias c for init', () => {
        const { stdout, exitCode } = run(__dirname, ['c', '--version'], false);
    ...
    it('outputs version with info', () => {
        const { stdout, exitCode } = run(__dirname, ['info', '--version'], false);
    ...
    it('outputs version with serve', () => {
        const { stdout, exitCode } = run(__dirname, ['serve', '--version'], false);
    ...
    it('outputs version with migrate', () => {
        const { stdout, exitCode } = run(__dirname, ['migrate', '--version'], false);
    ...
    it('outputs version with plugin', () => {
        const { stdout, exitCode } = run(__dirname, ['plugin', '--version'], false);
    ...
    it('outputs version with loader', () => {
        const { stdout, exitCode } = run(__dirname, ['loader', '--version'], false);
    ...
    it(' should throw error if invalid argument is present with --version flag', () => {
        const { stdout, stderr, exitCode } = run(__dirname, ['init', 'abc', '--version'], false);
    ...
    it(' should throw error if invalid argument is present with -v alias', () => {
        const { stdout, stderr, exitCode } = run(__dirname, ['init', 'abc', '-v'], false);
