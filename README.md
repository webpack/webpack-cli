...
The `migrate` feature eases the transition from [version 1](http://webpack.github.io/docs/), to [version 2](https://gist.github.com/sokra/27b24881210b56bbaff7). This feature allows users to switch to the new version of webpack, without having to extensively [refactor](https://webpack.js.org/guides/migrating/).
