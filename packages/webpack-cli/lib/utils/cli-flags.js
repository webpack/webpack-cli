...
const builtInFlags = [
    ...
    // For webpack@4
    ...(!cli ? Object.values(flagsForWebpack4) : []),
];
...
const coreFlags = cli
    ? Object.entries(cli.getArguments()).map(([flag, meta]) => {
          ...
          const legacyMetadata = flagsForWebpack4[flag] || {};

          if (inBuiltIn) {
              return { ...meta, name: flag, group: 'core', ...inBuiltIn, ...legacyMetadata };
          }

          return { ...meta, name: flag, group: 'core', ...legacyMetadata };
      })
    : [];
const flags = []
