...
class Info {
    private DEFAULT_DETAILS: Information = {
    ...
    public async info(...args): Promise<string[]> {
        ...
        let output = await envinfo.run(this.DEFAULT_DETAILS, envinfoConfig);
...
// async function info(...args): Promise<string[]> {
//     const cli = new WebpackCLI();
//     const parsedArgs = cli.argParser(options, args, true);
//     const infoArgs = parsedArgs.opts;
//     const envinfoConfig = {};
