...
export default async function entry(self: CustomGenerator, multiEntries: boolean, autoGenerateDefaults = false): Promise<void | {}> {
    const webpackEntryPoint: object = {};
    // TODO: refactoring to async/await
    async function forEachPromise(entries: string[], fn: (entryProp: string) => Promise<void | {}>): Promise<object | {}> {
