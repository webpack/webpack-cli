...
What we are meaning here, is if you want to provide your bundle as a single entry point. If you have only one entry to your app, answer yes. If you got more modules you want to bundle, answer no.
...
If you answer `Yes` to this, we add `ExtractTextPlugin` to your loaders. This means that your style files will be seperated in production from the bundles where they are used. If you answer `No`, we will not use the plugin, and `Question 6` will be ignored by default.
