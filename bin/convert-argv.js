...
module.exports = function(yargs, argv, convertOptions) {
	...
	function processOptions(options) {
		...
		ifArg('optimize-min-chunk-size', function(value) {
			ensureArray(options, 'plugins');
			var MinChunkSizePlugin = webpack.optimize.MinChunkSizePlugin;
		...
		ifArg('prefetch', function(request) {
			ensureArray(options, 'plugins');
			var PrefetchPlugin = webpack.PrefetchPlugin;
		...
		// TODO LabeledModulesPlugin is not exposed by webpack
		// ifBooleanArg('labeled-modules', function() {
		// 	ensureArray(options, 'plugins');
		// 	var LabeledModulesPlugin = webpack.dependencies.LabeledModulesPlugin');
