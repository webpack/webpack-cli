...
module.exports = function(yargs, argv, convertOptions) {
	...
	function processOptions(options) {
		...
		ifBooleanArg("hot", function() {
			ensureArray(options, "plugins");
			var HotModuleReplacementPlugin = require("../node_modules/webpack/lib/otModuleReplacementPlugin");
		...
		ifBooleanArg("optimize-minimize", function() {
			ensureArray(options, "plugins");
			var UglifyJsPlugin = require("../node_modules/webpack/lib/UglifyJsPlugin");
			var LoaderOptionsPlugin = require("../node_modules/webpack/lib/LoaderOptionsPlugin");
		...
		ifArg("prefetch", function(request) {
			ensureArray(options, "plugins");
			var PrefetchPlugin = require("../node_modules/webpack/lib/PrefetchPlugin");
