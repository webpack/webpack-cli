...
module.exports = function(j: Ijscodeshit, ast: IPath<*>): IPath<*> {
	...
	const createLoaderWithQuery = (
		...
		let queryProp: IProperty<IObjectExpression> = j.property(
			"init",
	 ...
	 */
	const prepostLoaders = (): IPath<IObjectExpression> =>
		ast
	 ...
	 * @return {[type]}       [description]
	 */
	const loadersToRules = (): IPath<IIdentifier> =>
		ast
			.find(j.Identifier)
	 ...
	 * @returns {Node} []
	 */
	const loadersToArrayExpression = (): IPath<IObjectExpression> =>
		ast
			.find(j.ObjectExpression)
	 ...
	 * @returns {Node} []
	 */
	const loaderWithQueryParam = (): IPath<IObjectExpression> =>
		ast
			.find(j.ObjectExpression)
	 ...
	 * @returns {Node} []
	 */
	const loaderWithQueryProp = (): IPath<IIdentifier> =>
		ast
			.find(j.Identifier)
	 ...
	 * @returns {Node} []
	 */
	const addLoaderSuffix = (): IPath<IObjectExpression> =>
