...
export type Ijscodeshit = {
	...
	variableDeclaration: (declarationName: string, declaratino: any) => IPath<IVariableDeclarator>,
	variableDeclarator: (declarator: any, expression: any) => IPath<IVariableDeclarator>,
