...
module.exports = class WebpackGenerator extends Generator {
	...
	prompting() {
		...
		.then( (answer) => {
			...
			this.configuration.webpackOptions.resolve.unsafeCache = pureRegExp("'/src\\/utilities/'")
			...
			this.configuration.webpackOptions.externals = {
				jquery: 'jQuery',
				subtract: [createPathProperty('path.join', '__dirname', answer.entry), 'subtract'],
				lodash : {
   					commonjs: "lodash",
   					amd: "lodash",
