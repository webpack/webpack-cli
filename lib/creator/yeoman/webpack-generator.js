...
const commonChunksPluginCreate = require('webpack-addons').commonChunksPluginCreate;
const createPathProperty = require('webpack-addons').createPathProperty;
const createRequire = require('webpack-addons').createRequire;
const regularFunction = require('webpack-addons').regularFunction;
...
module.exports = class WebpackGenerator extends Generator {
	...
	prompting() {
		...
		this.configuration.webpackOptions.output.path = createPathProperty('path.resolve', '__dirname', 'something');
		...
		this.configuration.webpackOptions.resolve.cachePredicate = regularFunction(true, 'cachePredicate')
		...
		this.configuration.topScope = [createRequire('path'), createRequire('webpack'), parseValue('const myCache = {};')]
	}
