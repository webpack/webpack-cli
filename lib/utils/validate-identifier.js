...
function isKeyword(code) {
	switch (code.length) {
		...
		case 3:
			return (code === "var") || (code === "for") || (code === "new") ||
				(code === "try") || (code === "let");
		case 4:
			return (code === "this") || (code === "case") ||
				(code === "void") || (code === "with") || (code === "enum") || (code === "true") ||
				(code === "null") || (code === "eval");
		case 5:
			return (code === "while") || (code === "break") || (code === "catch") ||
				(code === "throw") || (code === "const") || (code === "yield") ||
				(code === "class") || (code === "super") || (code === "false") || (code === "await");
		case 6:
			return (code === "return") || (code === "typeof") || (code === "delete") ||
				(code === "switch") || (code === "export") || (code === "import") ||
				(code === "static") || (code === "public") ;
		case 7:
			return (code === "default") || (code === "finally") || (code === "extends") ||
				(code === "private") || (code === "package");
		case 8:
...
function isIdentifierStart(code) {
	...
	if (c <= 0xffff) return c >= 0xaa && nonASCIIidentifierStart.test(String.fromCharCode(c));
