// @flow
import type { IPath } from "../types"; // eslint-disable-line node/no-unsupported-features
...
function transformSingleAST(ast: IPath<*>, source: string, transformFunction: Function): IPath<*> {
 ...
 * */
function transform(source: string, transforms: Function[], options: Object): string {
	const ast: IPath<*> = jscodeshift(source);
