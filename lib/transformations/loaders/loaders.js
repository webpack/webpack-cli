...
module.exports = function(j, ast) {
	...
	const checkForLoader = p => p.value.name === "loaders" && utils.safeTraverse(p, ["parent", "parent", "parent", "node", "key", "name"]) === "module";
	...
	const loaderToUse = () => ast
		...
		.filter(p => {
			return (p.value.name === "loaders" || p.value.name === "loader") &&
				utils.safeTraverse(p, ["parent", "parent", "parent", "parent", "node", "key", "name"]) === "rules";
		})
