...
module.exports = function(j, ast) {
	...
	const createArrayExpression = function(path) {
		path.parent.node.value = j.arrayExpression(
			utils.safeTraverse(path, ['parent', 'node', 'value', 'value'])
				// Split loaders string into array of loaders
				.split('!')
				// For each separate loader create an object { loader: LOADER }
