// @flow
import type { Ijscodeshit, IPath, IArrayExpression } from '../../types'; // eslint-disable-line node/no-unsupported-features
...
module.exports = function(j: Ijscodeshit, ast: IPath<*>) {
	...
	return ast
		...
		.filter((path: IPath<*>) => safeTraverse(path, ['parent', 'value', 'key', 'name']) === 'plugins')
