    ...
    (function() {
        ...
        (t.version = '0.5.3'),
            ...
            (t.SortedSet.prototype.union = function(t) {
                var e, n, i;
                return (
                    this.length >= t.length ? ((e = this), (n = t)) : ((e = t), (n = this)), (i = e.clone()), i.add.apply(i, n.toArray()), i
                );
            }),
        ...
        Signature = (function(_super) {
            ...
            return (
                ...
                (Signature.prototype.setIndex = function(index) {
                    if (
                        (index < 0 && (index = 0), index > this.groups.length - 1 && (index = this.groups.length - 1), this.index != index)
                    ) {
